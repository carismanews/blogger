...
$(".mainswap .widget-content").show();var numOfSliderPosts=4,slider=$("#home-wrapper .widget-content"),sliderContent=slider.text().trim(),featurd="/-/"+sliderContent;"LATEST"==sliderContent.toUpperCase()&&(featurd="");var sqqe1="",sqqe2="",sqqe3="",sqqe4="";$.ajax({url:"/feeds/posts/default"+featurd+"?alt=json-in-script&max-results="+numOfSliderPosts,type:"get",dataType:"jsonp",success:function(e){for(var t=new Array,i=0;i<5;i++){for(var r,l=e.feed.entry[i],n=l.title.$t,o='<a class="post-category bg_red left worksans uppercase c_fff fw500" href="/search/label/'+l.category[0].term+'?max-results=7">'+l.category[0].term+"</a>",v=0;v<l.link.length;v++)if("alternate"==l.link[v].rel){r=l.link[v].href;break}var f=l.published.$t.substring(0,10),u=f.substring(0,4),p=f.substring(5,7),h=f.substring(8,10),m=["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Sep","Out","Nov","Dez"][parseInt(p-1)],g=l.published.$t.substring(0,19);if("content"in l)var q=l.content.$t;l.author[0].name.$t.split(" ").slice(0,1).join(" ");s=q,a=s.indexOf("<img"),b=s.indexOf('src="',a),c=s.indexOf('"',b+5),d=s.substr(b+5,c-b-5),-1!=a&&-1!=b&&-1!=c&&""!=d&&(t[i]=d);var w=t[i].replace("s1600/","s0/"),x=t[i].replace("s1600/","s600/");0===i&&(sqqe1='<div class="box1 left relative"><div class="xhid"><a href='+r+'><div class="img shots" style="background: #444444 url('+w+') no-repeat center;background-size: cover"></div></a><div class="box-title">'+o+'<a href="'+r+'" class="slider-post-title"><h3 class="title worksans fw700 c_fff left relative m0">'+n+'</h3></a><time class="timeago left relative worksans fw400 uppercase c_999" datetime='+g+">"+h+" "+m+", "+u+"</time></div></div></div>"),1===i&&(sqqe2='<div class="box2 left relative"><div class="xhid"><a href='+r+'><div class="img shots" style="background: #444444 url('+x+') no-repeat center;background-size: cover"></div></a><div class="box-title left relative"><div class="box-title-sub relative">'+o+'<a href="'+r+'" class="slider-post-title"><h3 class="title worksans fw700 c_222 left relative">'+n+'</h3></a><time class="timeago left relative worksans fw400 uppercase c_999" datetime='+g+">"+h+" "+m+", "+u+"</time></div></div></div></div>"),2===i&&(sqqe3='<div class="box2 left relative"><div class="xhid"><a href='+r+'><div class="img shots" style="background: #444444 url('+x+') no-repeat center;background-size: cover"></div></a><div class="box-title left relative"><div class="box-title-sub relative">'+o+'<a href="'+r+'" class="slider-post-title"><h3 class="title worksans fw700 c_222 left relative">'+n+'</h3></a><time class="timeago left relative worksans fw400 uppercase c_999" datetime='+g+">"+h+" "+m+", "+u+"</time></div></div></div></div>"),slider.html(sqqe1+sqqe2+sqqe3)}}});
